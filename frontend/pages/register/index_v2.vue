      ...
      <form @submit.prevent="handleRegister" novalidate>
        ...
        <div v-if="currentStep === 1">
          ...
          <div class="mb-4">
            ...
            <p v-else class="mt-1 text-xs text-gray-500">
              ต้องประกอบด้วย A–Z, a–z และตัวเลข 0–9
            </p>
          </div>
          <div class="mb-6">
            <label
        ...
        <div v-if="currentStep === 2">
          ...
          <div class="mb-4">
            <label for="phoneNumber" class="block mb-1 text-sm font-medium text-gray-700"
        ...
        <div v-if="currentStep === 3">
          ...
          <div class="mb-4">
            <label for="idNumber" class="block mb-1 text-sm font-medium text-gray-700"
          ...
          <div class="mb-4">
            <label for="expiryDate" class="block mb-1 text-sm font-medium text-gray-700"
          ...
          <div class="mb-4">
            <label class="block mb-1 text-sm font-medium text-gray-700"
              >รูปถ่ายใบหน้าปกติ (Selfie) <span class="text-red-500">*</span></label
            >
            <div
              v-if="!selfiePreview"
          ...
          >
            ...
            <ul class="space-y-1">
              ...
              <li class="flex items-center">
                <i class="mr-2 text-red-500 fa-solid fa-circle-xmark"></i>แสงน้อยเกินไป
              </li>
              <li class="flex items-center">
                <i class="mr-2 text-red-500 fa-solid fa-circle-xmark"></i>ระยะไกลเกินไป
              </li>
            </ul>
          </div>
          <div class="mb-6">
...
const formatExpiryDate = () => {
  ...
  if (digits.length <= 2) {
    ...
    formData.expiryDate = `${digits.slice(0, 2)}/${digits.slice(2, 4)}/${digits.slice(
      4,
      8
    )}`;
  }
